        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="space-y-8">
              ...
              >
                Building <span className="text-[#6179f6]">Intelligent</span>{" "}
                Machines
              </h1>
              ...
              <div className="flex items-center gap-2">
                <div
                  style={{
                    background: "linear-gradient(to right, #6179f6, #6179f6)",
                  }}
                  className="w-7 h-1.5 rounded-full"
                ></div>
                <div
                  style={{
                    background: "linear-gradient(to right, #ff914d, #ff914d)",
                  }}
                  className="w-7 h-1.5 rounded-full"
                ></div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <span className="text-[#6179f6] font-semibold">evolve</span> in
            ...
            <div className="grid grid-cols-3 gap-12 pt-12 animate-fade-in delay-500">
              <div className="text-center group">
                <div className="relative">
                  <div
                    className="text-5xl font-black text-[#6179f6] group-hover:scale-110 transition-transform duration-300"
                    style={{ fontFamily: "Montserrat" }}
                  >
                ...
                <div
                  className="text-sm font-medium text-gray-600 mt-2 uppercase tracking-wider"
                  style={{ fontFamily: "Rubik" }}
                >
                  Active Projects
                </div>
              ...
              <div className="text-center group">
                <div className="relative">
                  <div
                    className="text-5xl font-black text-[#ff914d] group-hover:scale-110 transition-transform duration-300"
                    style={{ fontFamily: "Montserrat" }}
                  >
                    {data["publications"]}+
                  </div>
